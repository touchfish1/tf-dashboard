      ...
      <ScrollView className="flex-1 px-4" contentContainerClassName="py-4 gap-4">
        ...
        <View className="flex-row gap-3">
          <Card className="flex-1 items-center py-4 gap-1">
            <Ionicons name="pulse-outline" size={18} color="#c23a2b" />
          ...
          <Card className="flex-1 items-center py-4 gap-1">
            <Ionicons name="server-outline" size={18} color="#c23a2b" />
            <Text className="text-lg font-bold text-ink dark:text-ink-dark font-mono">
          ...
          <Card className="flex-1 items-center py-4 gap-1">
            <Ionicons name="time-outline" size={18} color="#c23a2b" />
        ...
        {summary && (
          <Card className="gap-2">
            ...
            <View className="flex-row items-center gap-3">
                <View className="flex-1 h-2 rounded-full bg-line dark:bg-line-dark overflow-hidden">
                <View
